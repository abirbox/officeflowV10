...
const createOfficeIcon = () => L.divIcon({
  ...
  html: `<div style="background:#0EA5E9;width:30px;height:30px;border-radius:8px;border:3px solid white;box-shadow:0 4px 14px rgba(79,70,229,0.5);display:flex;align-items:center;justify-content:center;color:white;font-weight:bold;font-size:16px;">⌂</div>`,
  iconSize: [30, 30],
  iconAnchor: [15, 15],
});
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <Avatar className="w-8 h-8">
                        ...
                        <AvatarFallback className="text-xs bg-[#0EA5E9] text-white">
                    ...
                    {emp.current_location ? (
                      <p className="text-xs text-[#0EA5E9] flex items-center gap-1 mt-1 font-medium">
